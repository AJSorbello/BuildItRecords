  ...
  records: [
    {
      ...
      coverImage: 'https://placehold.co/300x300/222/fff?text=House+Essentials',
    ...
    },
    {
      ...
      coverImage: 'https://placehold.co/300x300/222/fff?text=Deep+House+Vibes',
    ...
    },
    {
      ...
      coverImage: 'https://placehold.co/300x300/222/fff?text=Underground+House',
  ...
  tech: [
    {
      ...
      coverImage: 'https://placehold.co/300x300/222/fff?text=Techno+Warehouse',
    ...
    },
    {
      ...
      coverImage: 'https://placehold.co/300x300/222/fff?text=Industrial+Techno',
  ...
  deep: [
    {
      ...
      coverImage: 'https://placehold.co/300x300/222/fff?text=Deep+House+Sessions',
      spotifyUrl: 'https://open.spotify.com/playlist/37i9dQZF1DX2TRYkJECvfC',
      followers: 3800,
      tracks: 90,
    },
    {
      ...
      coverImage: 'https://placehold.co/300x300/222/fff?text=Melodic+Deep',
      spotifyUrl: 'https://open.spotify.com/playlist/37i9dQZF1DX2TRYkJECvfC',
    },
  ],
};
