...
const RecordsPage = () => {
    ...
    (0, react_1.useEffect)(() => {
        const fetchData = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                setLoading(true);
                // Fetch artists
                const recordsArtists = yield DatabaseService_1.databaseService.getArtistsForLabel(labels_1.RECORD_LABELS['buildit-records']);
    ...
    if (loading) {
        return ((0, jsx_runtime_1.jsx)(PageLayout_1.default, Object.assign({ label: "records" }, { children: (0, jsx_runtime_1.jsx)(material_1.Box, Object.assign({ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "80vh" }, { children: (0, jsx_runtime_1.jsx)(material_1.CircularProgress, {}) })) })));
    }
    if (error) {
        return ((0, jsx_runtime_1.jsx)(PageLayout_1.default, Object.assign({ label: "records" }, { children: (0, jsx_runtime_1.jsx)(material_1.Box, Object.assign({ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "80vh" }, { children: (0, jsx_runtime_1.jsx)(material_1.Typography, Object.assign({ color: "error" }, { children: error })) })) })));
    }
    return ((0, jsx_runtime_1.jsx)(PageLayout_1.default, Object.assign({ label: "records" }, { children: (0, jsx_runtime_1.jsxs)(material_1.Box, Object.assign({ sx: { flexGrow: 1, p: 3 } }, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, Object.assign({ variant: "h4", gutterBottom: true }, { children: "Build It Records Artists" })), (0, jsx_runtime_1.jsx)(material_1.Grid, Object.assign({ container: true, spacing: 4 }, { children: artists.map((artist) => ((0, jsx_runtime_1.jsx)(material_1.Grid, Object.assign({ item: true, xs: 12, sm: 6, md: 4 }, { children: (0, jsx_runtime_1.jsx)(material_1.Card, { children: (0, jsx_runtime_1.jsxs)(material_1.Box, Object.assign({ sx: { position: 'relative' } }, { children: [(0, jsx_runtime_1.jsx)(material_1.CardMedia, { component: "img", height: "200", image: artist.images && artist.images.length > 0 ? artist.images[0].url : 'https://via.placeholder.com/200', alt: artist.name }), (0, jsx_runtime_1.jsxs)(material_1.CardContent, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, Object.assign({ variant: "h6", component: "div" }, { children: artist.name })), (0, jsx_runtime_1.jsx)(material_1.Typography, Object.assign({ variant: "body2", color: "text.secondary", sx: {
                                                    height: '3em',
                                                    overflow: 'hidden',
                                                    mb: 2
                                                } }, { children: artist.bio || `Artist on ${labels_1.RECORD_LABELS['buildit-records'].displayName}` })), (0, jsx_runtime_1.jsx)(material_1.Box, Object.assign({ sx: {
                                                    display: 'flex',
