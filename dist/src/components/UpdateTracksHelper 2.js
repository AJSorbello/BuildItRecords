...
const UpdateTracksHelper = () => {
    (0, react_1.useEffect)(() => {
        ...
        const updatedTracks = tracks.map((track) => {
            ...
            if (track.spotifyUrl && track.recordLabel !== labels_1.RECORD_LABELS['Build It Deep']) {
                return Object.assign(Object.assign({}, track), { recordLabel: labels_1.RECORD_LABELS['Build It Deep'] });
            }
            return track;
        });
