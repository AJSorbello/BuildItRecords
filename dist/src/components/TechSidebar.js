...
const TechSidebar = ({ open = true, onClose, variant, sx }) => {
    const navigate = (0, react_router_dom_1.useNavigate)();
    const color = theme_1.labelColors.tech;
    const menuItems = [
        { text: 'Home', icon: (0, jsx_runtime_1.jsx)(Home_1.default, {}), path: '/tech' },
        { text: 'Releases', icon: (0, jsx_runtime_1.jsx)(Album_1.default, {}), path: '/tech/releases' },
        { text: 'Artists', icon: (0, jsx_runtime_1.jsx)(People_1.default, {}), path: '/tech/artists' },
        { text: 'Submit', icon: (0, jsx_runtime_1.jsx)(Send_1.default, {}), path: '/tech/submit' },
    ];
