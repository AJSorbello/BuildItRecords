        ...
        const release = await Release.findByPk(req.params.id, {
            include: [
                ...
                },
                {
                    ...
                    as: 'tracks',
                    attributes: [
                      'id', 'title', 'duration', 'track_number', 'disc_number', 
    ...
    const release = await Release.findOne({
      ...
      include: [
        ...
        },
        {
          ...
          as: 'tracks',
          attributes: [
            'id', 'title', 'duration', 'preview_url', 'spotify_url', 
            'spotify_uri', 'track_number', 'popularity', 'remixer_id'
          ]
        }
      ]
    });
    ...
    const completeRelease = await Release.findByPk(newRelease.id, {
      include: [
        ...
        },
        {
          model: Track,
          as: 'tracks',
          attributes: ['id', 'title', 'duration', 'preview_url', 'spotify_url', 'track_number'],
          include: [
            {
              model: Artist,
              as: 'artists',
